...
import { ManagementUserInActiveSkelaton } from "@/components/dashboard/management-users/user/ManagementUserSkelaton";
...
export default function UserInActive() {
    ...
    if (isLoading) {
        return (
            <ManagementUserInActiveSkelaton />
        );
    }
            ...
            <Card className="border-2 shadow-lg">
                <CardHeader className="pb-4 border-b bg-muted/20">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <CardTitle className="text-2xl font-bold tracking-tight">Inactive Users</CardTitle>
                ...
                <CardContent>
                    ...
                    {currentUsers.length === 0 ? (
                        <div className="text-center py-16 px-4">
                            ...
                            <p className="text-foreground font-semibold text-lg mb-2">No inactive users found</p>
                            {hasActiveFilters ? (
                                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                                    No inactive users match your current filters. Try adjusting your search criteria.
                                </p>
                            ) : (
                                    ...
                                    <TableBody>
                                        {currentUsers.map((user) => (
                                            ...
                                            >
                                                ...
                                                <TableCell className="py-4">
                                                    <Badge variant="secondary" className="border font-semibold capitalize">inactive</Badge>
                                                </TableCell>
                                                <TableCell className="py-4">
                                                    <Badge
                                                        variant={
