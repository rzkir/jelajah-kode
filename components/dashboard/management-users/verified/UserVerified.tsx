...
import { ManagementUserVerifiedSkelaton } from "@/components/dashboard/management-users/user/ManagementUserSkelaton";
...
export default function UserVerified() {
  const {
    ...
    handleRoleChange,
    formatDate,
  } = useStateUsers({ initialVerified: "verified" });
  ...
  if (isLoading) {
    return (
      <ManagementUserVerifiedSkelaton />
    );
  }
      ...
      <Card className="border-2 shadow-lg">
        <CardHeader className="pb-4 border-b bg-muted/20">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <CardTitle className="text-2xl font-bold tracking-tight">Verified Users</CardTitle>
        ...
        <CardContent>
          ...
          {currentUsers.length === 0 ? (
            <div className="text-center py-16 px-4">
              ...
              <p className="text-foreground font-semibold text-lg mb-2">No verified users found</p>
              {hasActiveFilters ? (
                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                  No verified users match your current filters. Try adjusting your search criteria.
                </p>
              ) : (
                <p className="text-sm text-muted-foreground">
                  {searchTerm
                    ? `No verified users match your search for "${searchTerm}".`
                  ...
                  <TableBody>
                    {currentUsers.map((user) => (
                      ...
                      >
                        ...
                        <TableCell className="py-4">
                          <Badge variant="default" className="border font-semibold">Verified</Badge>
                        </TableCell>
                        <TableCell className="py-4">
                          {user.created_at
