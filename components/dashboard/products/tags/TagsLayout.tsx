...
import useStateProjectsTags from "@/components/dashboard/products/tags/lib/useStateProductsTags";

import FormModalProjectsTags from "@/components/dashboard/products/tags/modal/FormModalProductsTags";

import DeleteModalProjectsTags from "@/components/dashboard/products/tags/modal/DeleteModalProductsTags";
      ...
      <Card className="border-2 shadow-lg">
        <CardHeader className="pb-4 border-b bg-muted/20">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <CardTitle className="text-2xl font-bold tracking-tight">Tags</CardTitle>
            ...
            <div className="rounded-lg border-2 overflow-hidden">
              <div className="overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {tags.map((tag) => (
                      <TableRow key={tag._id} className="border-b hover:bg-muted/30 transition-colors">
