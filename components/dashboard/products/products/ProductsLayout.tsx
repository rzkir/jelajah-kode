...
import { Search, Plus, Pencil, Trash2, Eye, Grid3X3, List, Filter, Package, CheckCircle, FileText, Box, Image as ImageIcon, DollarSign, TrendingUp } from "lucide-react";
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {hasActiveFilters && filteredProductsCount !== totalProducts && (
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {hasActiveFilters && (
                  <p className="text-xs text-muted-foreground mt-1">
                    {products.filter(p => p.status === "publish").length} total
                  </p>
                )}
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {hasActiveFilters && (
                  <p className="text-xs text-muted-foreground mt-1">
                    {products.filter(p => p.status === "draft").length} total
                  </p>
                )}
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Total Value: Rp {formatIDR(totalValue)}
                </p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <CardDescription className="mt-1.5 text-base">
                  <span className="font-semibold text-foreground">{currentProducts.length}</span> product(s)
                  {hasActiveFilters && filteredProductsCount !== totalProducts && (
                    <span className="text-muted-foreground"> of <span className="font-semibold">{totalProducts}</span> total</span>
                  )}
                </CardDescription>
              </div>
