    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            ...
            try {
                ...
                // Filter hanya transaksi dengan status "expired"
    ...
    if (isLoading) {
        return (
            <section className="flex flex-col gap-6">
                <Card>
                    <CardHeader>
                        <CardTitle>Expired Transactions</CardTitle>
                    </CardHeader>
                    <CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Total: {transactions.length} expired transaction(s)
                    </p>
                </CardHeader>
                <CardContent>
                    {error ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-muted-foreground">No expired transactions found</p>
                        </div>
                    ) : (
                        <Table>
                            <TableHeader>
