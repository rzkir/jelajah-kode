            ...
            <div className="container mx-auto space-y-6 px-2 md:px-4 py-4 md:py-6">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
                    <div className="flex flex-col gap-2">
                        <h2 className="text-3xl md:text-4xl font-bold tracking-tight" suppressHydrationWarning>{t("products.mostSaled.title")}</h2>
                        <p className="text-muted-foreground text-lg" suppressHydrationWarning>{t("products.mostSaled.description")}</p>
                    </div>
                </div>
