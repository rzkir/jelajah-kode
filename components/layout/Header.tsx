...
import { MoveUpRight, LogOut, User, Settings, LayoutDashboard, Menu, CodeXml } from "lucide-react"
...
export default function Header() {
  ...
  return (
    <header className="fixed top-3 z-50 w-full">
      {/* Main container */}
      <div className=" px-4 xl:px-0 max-w-3xl mx-auto">
        <nav className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-800/50 px-4 py-4 flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative">
              <CodeXml className="size-6 text-blue-600 dark:text-blue-400 group-hover:rotate-12 transition-transform" />
            </div>
