                ...
                <div className="lg:col-span-3 space-y-12">
                    ...
                    <section id="use-license">
                        ...
                        <p className="text-muted-foreground mb-4">
                            ...
                            CodeMarket&apos;s website for personal, non-commercial transitory viewing only. This is the grant of a
                    ...
                    <section id="disclaimer">
                        ...
                        <p className="text-muted-foreground">
                            The materials on CodeMarket&apos;s website are provided on an &apos;as is&apos; basis. CodeMarket makes no
                    ...
                    <section id="limitations">
                        ...
                        <p className="text-muted-foreground">
                            ...
                            to use the materials on CodeMarket&apos;s website.
                        </p>
                    </section>
                    ...
                    <section id="accuracy">
                        ...
                        <p className="text-muted-foreground">
                            The materials appearing on CodeMarket&apos;s website could include technical, typographical, or
                    ...
                    <section id="materials">
                        ...
                        <p className="text-muted-foreground">
                            The materials on CodeMarket&apos;s website are copyrighted. CodeMarket owns the copyright to all original
