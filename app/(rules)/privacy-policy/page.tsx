                ...
                <div className="lg:col-span-3 space-y-12">
                    <section id="introduction">
                        ...
                        <p className="text-muted-foreground mb-4">
                            CodeMarket (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates the CodeMarket website. This page
                    ...
                    <section id="data-usage">
                        ...
                        <p className="text-muted-foreground mb-4">CodeMarket uses the collected data for various purposes:</p>
                        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    ...
                    <section id="contact">
                        ...
                        <p className="text-muted-foreground">
                            ...
                            <Link href="mailto:privacy@codemarket.com" className="text-primary hover:underline">
                                privacy@codemarket.com
                            </Link>
                        </p>
                    </section>
                </div>
